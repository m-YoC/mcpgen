...
var iWordListLorem = []string{"resource/LoremIpsum.txt"}
const oYamlLorem = "yaml/lorem.yml"

var iWordListEn = []string{"resource/en_wordlist.txt"}
const oYamlEn = "yaml/en.yml"
...
func createYAML() {
  makeData(iWordListLorem, oYamlLorem)
  makeData(iWordListEn, oYamlEn)
}
...
func main() {
  ...
  app.Flags = []cli.Flag{
    ...
    &cli.StringFlag{
      Name:        "separators",
      Aliases:     []string{"s", "delimiters"},
      Usage:       "Set separators/delimiters between words",
      Hidden:      false,
      Value:       ".",
    },
    &cli.BoolFlag{
